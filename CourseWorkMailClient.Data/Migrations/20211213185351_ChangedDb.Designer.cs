...
namespace CourseWorkMailClient.Data.Migrations
{
    ...
    [Migration("20211213185351_ChangedDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseWorkMailClient.Domain.FolderType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CourseWorkMailClient.Domain.Interlocutor", b =>
                {
                    ...
                    b.Property<int?>("UserLastDESRsaKeyId")
                        .HasColumnType("int");

                    b.Property<int?>("UserLastMD5RsaKeyId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UserLastDESRsaKeyId");

                    b.HasIndex("UserLastMD5RsaKeyId");
            ...
            modelBuilder.Entity("CourseWorkMailClient.Domain.Folder", b =>
                {
                    b.HasOne("CourseWorkMailClient.Domain.FolderType", "FolderType")
                        .WithMany()
            ...
            modelBuilder.Entity("CourseWorkMailClient.Domain.Interlocutor", b =>
                {
                    ...
                    b.HasOne("CourseWorkMailClient.Domain.Keys.DESRsaKey", "UserLastDESRsaKey")
                        .WithMany()
                        .HasForeignKey("UserLastDESRsaKeyId");

                    b.HasOne("CourseWorkMailClient.Domain.Keys.MD5RsaKey", "UserLastMD5RsaKey")
                        .WithMany()
                        .HasForeignKey("UserLastMD5RsaKeyId");

                    b.Navigation("LastDESRsaKey");

                    b.Navigation("LastMD5RsaKey");

                    b.Navigation("UserLastDESRsaKey");

                    b.Navigation("UserLastMD5RsaKey");
                });
            ...
            modelBuilder.Entity("CourseWorkMailClient.Domain.User", b =>
                {
                    b.HasOne("CourseWorkMailClient.Domain.Interlocutor", "Interlocutor")
                        .WithMany()
